...
- Première version pour ordinateur avec clavier et souris ; adaptation tactile dans une étape ultérieure.
...
Commandes : ZQSD, WASD ou flèches pour marcher ; E pour interagir à proximité ; Espace au départ de la bande terracotta pour commencer le jogging ; F pour descendre d’un véhicule. Suivre la bande jusqu’à l’arrivée. Des boutons directionnels sont proposés sur écran tactile, sans validation mobile complète.
...
- **Corniche Est** : trottoir pavé large, cocotiers en fosses carrées, muret blanc côté mer, chaussée à ligne axiale et lignes de rive, lampadaires à double crosse, paillotes sur pilotis, cordon dunaire. La bande de jogging correspond à la piste de mise en forme prévue dans l’aménagement réel.
- **Monument de l’Amazone** : guerrière debout, fusil dressé crosse au sol, sabre courbe pointé vers le bas, bandoulière, pagne noué, épaulière, butte de roche et socle à plaque, à l’échelle d’un monument de trente mètres, sur une esplanade ouverte avec les portiques du port à l’horizon.
...
Une première livraison de six modèles Meshy est arrivée ; cinq sont en place. La statue de
...
tenue de sport près de la piste de mise en forme.

Les fichiers bruts pesaient 485 Mo pour 12 millions de triangles ; après décimation et compression
des textures ils tiennent en 4,1 Mo. Le détail de la chaîne, le tableau des modèles et la raison
...
- Huit tests de logique réussis : commerce, portefeuille partagé, transport, progression, jogging et placement des modèles après rotation.
- Trois tests Playwright réussis : marche vers le guide et la vendeuse, achat et inventaire ; accueil à 390 pixels ; chargement des cinq modèles actifs, cinq guides, paiement du zémidjan, descente et fin de démo. Pour ce dernier test, les positions aux entrées des zones sont simulées ; il ne constitue pas une traversée complète à pied.
...
- Les six modèles Meshy ont été rendus un par un avant et après optimisation, puis contrôlés en place dans la scène. C’est ce contrôle qui a conduit à écarter celui de l’Étoile Rouge.
- Regard vertical vérifié : la caméra dégage bien le sommet des monuments, hauts de vingt-cinq à trente-cinq mètres.
- Reconnaissance vocale, restitution sonore, parcours de jogging complet et trajets en zémidjan ou en voiture restent à vérifier manuellement ; aucun test d’audio réel n’a été réalisé.
...
Les abords comportent désormais des devantures variées, enseignes fictives, auvents, petits étals, kiosques, balcons, terrasses et deux percées latérales. Vingt véhicules décoratifs et sept passants suivent des trajectoires animées. Les personnages construits en code ont des volumes arrondis et des tenues variées ; cela ne remplace pas le travail d'animation des futurs personnages Meshy.
