...
export const zones = [
  ...
  new Zone('amazone', 'L’Esplanade', 'L’Amazone & la Présidence.', -90, [
    ...
    new Guide('presidence', 'Le Palais de la Marina', 'Le Palais de la Marina est la résidence officielle du président de la République du Bénin. Il borde le boulevard de la Marina, face à l’océan et à l’esplanade des Amazones. Notre balade réunit ces deux lieux dans une seule zone. Reconnais son long corps de bâtiment porté par des piliers, ses bandeaux vitrés et ses drapeaux, observés depuis l’espace public. Retrouve ensuite Aïcha au stand, puis poursuis vers le Palais des Congrès.', 3, -145, 'https://presidence.bj/palais/'),
  ]),
