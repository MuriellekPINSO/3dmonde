...
export const zones = [
  ...
  new Zone('etoile', 'L’Étoile Rouge', 'La ville se croise ici.', -330, [
    new Guide('etoile', 'La place de l’Étoile Rouge', 'Voici l’Étoile Rouge, grand rond-point où se rejoignent cinq voies : voitures et zémidjans en font le tour sans s’arrêter. Sur l’île centrale, deux étoiles rouges à cinq branches, imbriquées, entourent une haute flèche blanche. À son sommet, la statue d’un homme brandit une houe, un fusil à l’épaule et un fagot de bois à la main : l’agriculture, le service militaire et l’énergie domestique. Le monument a été construit au milieu des années 1970 par des ingénieurs soviétiques, sous Mathieu Kérékou, pendant la période marxiste-léniniste. Tu es au bout de notre parcours : découvre les cinq lieux pour compléter ton carnet de balade.', 5.3, -360.5, 'https://fr.wikipedia.org/wiki/Place_de_l%27%C3%89toile_rouge'),
  ]),
];
