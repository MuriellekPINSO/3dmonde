...
test('rues habitées : circulation, pause, son facultatif et captures',async({page})=>{
 ...
 await page.getByRole('button',{name:'Carte · 0/5'}).click();await page.waitForTimeout(300);const paused=await z();await page.waitForTimeout(400);expect(await z()).toBe(paused);await page.keyboard.press('Escape');
